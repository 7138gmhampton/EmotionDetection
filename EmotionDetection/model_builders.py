...
def build_shanks():
    ...
    model.add(Conv2D(NO_OF_FEATURES, kernel_size=(3,3), activation='relu', input_shape=(FACE_BOUND_SCALED,FACE_BOUND_SCALED,1),data_format='channels_last', kernel_regularizer=l2()))
